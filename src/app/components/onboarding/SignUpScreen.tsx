...
export function SignUpScreen({ onBack, onSignUp, onSignInInstead }: SignUpScreenProps) {
    ...
    <div className="min-h-screen flex flex-col bg-white max-w-md mx-auto">
      ...
      <div className="flex-1 px-6 pt-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-4 bg-[#B8E8E4] text-white font-medium rounded-full hover:bg-[#5ECEC5] transition-colors mt-6"
          >
            Sign up with email
          </button>
        </form>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <span className="text-[#2D3142] font-medium">Sign up with Google</span>
          </button>
          ...
          >
            ...
            <span className="text-[#2D3142] font-medium">Sign up with Apple</span>
          </button>
        </div>
